...
Ainda com o intuito de possibilitar maior abrangência geográfica ao padrão, apenas dois anos após a aprovação da emenda IEEE 802.15.4a, foram introduzidas as emendas IEEE 802.15.4c \cite{IEEE802_15_4c} e IEEE 802.15.4d \cite{IEEE802_15_4d}, destinadas a introduzir novas definições para a camada PHY, compatíveis com a operação nas bandas de frequência ISM disponíveis na China e no Japão. IEEE 802.15.4c introduz definições para operação nas bandas de frequência 314-316 MHz, 430-434 MHz e 779-787 MHz, assim como adequações na camada MAC a fim de compatibilizar o padrão com as regulamentação vigente à época, na China. Já o IEEE 802.15.4d define o suporte à operação na banda de 950 MHz assim como adequações necessárias na camada MAC a fim de permitir a operação de acordo com as regulamentações vigentes à época, no Japão. Estas duas emendas foram incluídas na revisão seguinte, publicada como IEEE 802.15.4-2011 \cite{IEEE802_15_4_2011}, e introduzida com o objetivo de reestruturar a divisão dos requisitos aplicáveis às diferentes implementações definidas pelo padrão.

À época da elaboração do presente estudo, a última revisão realizada do padrão foi publicada como IEEE 802.15.4-2015 \cite{IEEE802_15_4_2015} e realizada com o intuito de introduzir as emendas propostas em IEEE 802.15.4e \cite{IEEE802_15_4e}, IEEE 802.15.4f \cite{IEEE802_15_4f} e IEEE 802.15.4g \cite{IEEE802_15_4g}. As alterações contidas nesta revisão incluem o suporte a diversas novas definições para a camada PHY e funcionalidades adicionais para a camada MAC, como novos formatos de \textit{frame}, priorização de acesso aos canais e também mecanismos para redução do consumo de energia. Existem ainda diversas propostas de emenda aguardando a próxima revisão. Dentre elas se destaca o IEEE 802.15.4q \cite{IEEE802_15_4q}, cujo foco é no suporte à definição de PHYs \textit{Ultra Low Power}(ULP), destinados a dispositivos de baixo consumo, alimentados por baterias e com previsão de vida útil de vários anos. Também se destaca o IEEE 802.15.4m \cite{IEEE802_15_4m}, que visa prover suporte para definições de camada PHY operando na faixa de 54 MHz a 862 MHz
\begin{center}
