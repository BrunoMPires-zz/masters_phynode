...
Este trabalho tem como objetivo explorar alternativas para mitigar os problemas de instabilidade inerentes aos links de comunicação via rádio utilizados nas redes de sensores sem fios, a fim de prover soluções alternativas ao adensamento da malha robustas e que não interfiram adequadas aos novos paradigmas de projeto associados a este tipo de sistema. 

Devido às restrições na complexidade, no consumo energético e nos custos de produção, os transmissores de rádio utilizados para este fim geralmente operam com baixa potência e pequenas taxas de transmissão. Isso faz com que os links estabelecidos se tornem bastante susceptíveis à variações intermitentes de qualidade, especialmente nos casos em que operam em frequências compartilhadas com outros sistemas, como a faixa de 2.4GHz, compartilhada com tecnologias bem difundidas como WiFi e Bluetooth.
