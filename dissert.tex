...
No entanto a confiabilidade dos estimadores citados acima é bastante limitada, uma vez que consideram uma quantidade limitada de parâmetros como base para seus resultados. A fim de obter resultados mais acurados já foram propostos diversos estimadores de qualidade capazes de considerar parâmetros provenientes tanto de hardware quanto de software. Esta abordagem tende a produzir estimativas mais confiáveis pois permite que seja considerada uma maior quantidade de parâmetros para composição dos resultados. \textit{Four-bit}, uma métrica proposta em \citeonline{Fonseca2007}, por exemplo, considera parâmetros provenientes das camadas de rede, link e física. Já \textit{Triangle Metric}, propsota em \citeonline{Boano2010}, considera parâmetros provenientes tanto da camada física quanto da camada de controle de acesso ao meio.
