...
Essencialmente foram executadas duas categorias de teste: a primeira delas visava avaliar a validade da utilização da diversidade de interfaces da forma como foi implementada em PhyNode, enquanto a segunda visa avaliar a eficiência dos algoritmos de seleção propostos por PhyMac.

Os testes enquadrados na primeira categoria consistiam na transmissão de 5000 \textit{beacons}, a um intervalo fixo de 100ms, utilizando para tal a o método de transmissão mais simples possível: através de todas as interfaces simultaneamente. A escolha da quantidade de pacotes e intervalo de envio também se deu experimentalmente e teve como objetivo fornecer um espaço amostral suficientemente amplo para posterior análise dos dados, minimizando o tempo gasto com cada rodada de testes.
